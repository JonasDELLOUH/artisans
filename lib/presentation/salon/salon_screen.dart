                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Obx(() =>
                              CustomText(
                                text: "${controller.salon.value?.address} ${"at"
                                    .tr} ${(controller.betweenDistance.value >=
                                    1000)
                                    ? "${(controller.betweenDistance.value /
                      ...
                      Row(
                        children: [
                          Row(
                            children: stars(controller.salon.value?.nbrStar ??
                                0),
                          ),
                          const SizedBox(
                            width: 5,
                      ...
                      CustomScrollView(
                        ...
                        slivers: [
                          Obx(() =>
                          controller.storyIsInLoading.value
                              ? const SliverPadding(
                          ...
                          Obx(() =>
                          controller.postIsInLoading.value
                              ? const SliverPadding(
                            padding: EdgeInsets.zero,
                            sliver: SliverToBoxAdapter(
                                child: SizedBox(
                      ...
                      child: InkWell(
                        ...
                        child: Obx(() =>
                            Image(
                                ...
                                image: controller.locationController.value
                                    .image)),
                      ));
                } else {
                  return Container(
...
Widget contactWidget({required String contactType,
