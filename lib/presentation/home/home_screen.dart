                                ...
                                Expanded(
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Obx(() => CustomText(
                                          text: "${(controller.starSalon.value!.nbrStar * 100/ 5).toString()} %" ,
                                          fontSize: 40,
                                        ...
                                        Obx(() =>  CustomText(
                                          text: "${controller.starSalon.value?.salonName}",
                                          fontSize: 15,
                                        )),
                                        CustomTextButton(
                                          ...
                                          fontSize: 10,
                                          onPressed: () {
                                            Get.toNamed(AppRoutes.salonRoute, arguments: [controller.starSalon.value]);
                                          },
                                          height: 40,
                                        )
                                      ],
